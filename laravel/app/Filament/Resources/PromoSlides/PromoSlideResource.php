...
class PromoSlideResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Слайд-приглашение';

    protected static ?string $modelLabel = 'слайд-приглашение';

    protected static ?string $pluralModelLabel = 'Слайд-приглашение';
